"""
eval/debate_no_memory_dis.py
Setup (iii) — No memory at all.
HotpotQA DISTRACTOR setting — with context paragraphs.

Run: CUDA_VISIBLE_DEVICES=3 python eval/debate_no_memory_dis.py
"""
...
def run_debate_no_memory(agents: list, case: dict, query_idx: int = 0) -> dict:
    query        = case["prompt"]
...
if __name__ == "__main__":
    ...
    box("DEBATE — NO MEMORY | 5 Agents | HotpotQA Distractor")
    ...
    for i, case in enumerate(cases):
        ...
        result = run_debate_no_memory(agents, case, query_idx=i)
    ...
    box("FINAL RESULTS")
    print(f"\n  Setup    : no_memory | 5 agents | HotpotQA Distractor | N={N}")
